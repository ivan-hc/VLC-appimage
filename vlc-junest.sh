...
DEPENDENCES="ca-certificates ca-certificates-mozilla $kvantumver jre8-openjdk libaacs libbluray libbdplus libdvdcss libdvdnav libdvdread libvdpau libxtst libxi vlc-bittorrent vlc-plugins-all $qtctver zvbi" #SYNTAX: "APP1 APP2 APP3 APP4...", LEAVE BLANK IF NO OTHER DEPENDENCIES ARE NEEDED
