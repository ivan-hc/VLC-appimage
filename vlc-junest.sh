...
rm -R -f ./$APP.AppDir/.junest/usr/bin/glslangValidator
...
rm -R -f ./$APP.AppDir/.junest/usr/bin/rav1e
...
rm -R -f ./$APP.AppDir/.junest/usr/share/alsa-card-profile
...
rm -R -f ./$APP.AppDir/.junest/usr/share/desktop-directories
